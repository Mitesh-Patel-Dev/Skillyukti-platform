        ...
        <section className="py-24 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    {/* <div className="absolute inset-0 bg-gradient-to-r from-orange-700 via-orange-600 to-orange-500 animate-gradient" /> */}
                    ...
                    <div className="relative py-16 sm:py-20 px-8 sm:px-16 text-center">
                        ...
                        <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
                            Join 1000+ students who are already building their dream
